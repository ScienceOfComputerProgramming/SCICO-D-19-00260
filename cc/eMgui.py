...
class MainWindow(Gtk.Window):
    ...
    def add_file_menu_actions(self, action_group):
        ...
        action_sem = Gtk.Action("SemMenu", "Analysis", None, None)
        action_group.add_action(action_sem)
        ...
        action_sem = Gtk.Action("TransfMenu", "Transformations", None, None)
        action_group.add_action(action_sem)
